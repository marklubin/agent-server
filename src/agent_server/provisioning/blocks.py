...
class AgentSpecificBlocks:
    ...
    REFLECTION_CONTEXT = BlockDefinition(
        label="reflection_context",
        description="Context for the current reflection task including session timeframe and key themes.",
        initial_value="",
    )
